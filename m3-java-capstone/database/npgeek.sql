...
SELECT parkcode, COUNT(parkcode) FROM survey_result GROUP BY parkcode ORDER BY parkcode asc;



SELECT parkcode, emailaddress, state, activitylevel, COUNT(parkcode) as counter FROM survey_result GROUP BY parkcode ORDER BY parkcode ASC;

SELECT COUNT(parkcode) FROM survey_result GROUP BY parkcode;

SELECT parkcode, COUNT(parkcode) as counter FROM survey_result GROUP BY parkcode ORDER BY counter DESC, parkcode ASC;

SELECT COUNT(*) FROM survey_result

SELECT parkcode, COUNT(parkcode) FROM survey_result GROUP BY parkcode;
SELECT COUNT(parkcode) FROM survey_result;

SELECT (SELECT parkcode, COUNT(parkcode) FROM survey_result GROUP BY parkcode) as ordered FROM survey_result;
